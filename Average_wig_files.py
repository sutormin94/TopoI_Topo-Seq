...
Dict_of_replicas={'Replic 1' : PWD + "WIG_NE_strand_specific_masked_FE_smoothed\\TopoI_Topo_Seq_1_no_Ara_IP_div_by_smoothed_no_Ara_mock_F.wig",
                  'Replic 2' : PWD + "WIG_NE_strand_specific_masked_FE_smoothed\\TopoI_Topo_Seq_2_no_Ara_IP_div_by_smoothed_no_Ara_mock_F.wig",
                  'Replic 3' : PWD + "WIG_NE_strand_specific_masked_FE_smoothed\\TopoI_Topo_Seq_3_no_Ara_IP_div_by_smoothed_no_Ara_mock_F.wig",}

#ID or short description of the track (will be the name of a track in IGV).
name='TopoI_no_Ara_F_N3E_FE_av_123'
#ID of chromosome (for w3110_Mu_SGS: NC_007779.1_w3110_Mu)
Chromosome_name='NC_007779.1_w3110_Mu'
#Output path for the final file.
PWD_out=PWD + "WIG_NE_strand_specific_masked_FE_smoothed_av\\"
